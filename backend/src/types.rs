...
pub fn u8_to_flight_state(value: u8) -> Option<FlightState> {
    match value {
        ...
        6 => Some(FlightState::Postinit),
        7 => Some(FlightState::Armed),
        8 => Some(FlightState::Launch),
        9 => Some(FlightState::Ascent),
        10 => Some(FlightState::Coast),
        11 => Some(FlightState::Apogee),
        12 => Some(FlightState::Descent),
        13 => Some(FlightState::Reefing),
        14 => Some(FlightState::Landed),
        15 => Some(FlightState::Recovery),
        16 => Some(FlightState::Aborted),
        _ => None,
    }
}
